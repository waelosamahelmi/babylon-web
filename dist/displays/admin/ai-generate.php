<?php
// AI Ad Generator using OpenRouter
...
CAROUSEL EXAMPLE STRUCTURE (for multiple images):
```css
@keyframes slideshow {
  0%, 30% { opacity: 1; }
  33%, 97% { opacity: 0; }
...
.slide { position: absolute; animation: slideshow 12s infinite; }
...
// Build messages with vision capability
// Build messages - simple text format (not vision)
$messages = [
    [
        'role' => 'system',
